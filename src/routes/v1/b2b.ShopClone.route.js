...
router.route('/getFinal/CUstome/Pincodes').get(b2bShopCloneController.getFinal_CUstomer_Pincodes)
router.route('/get/final/customer/shops/Maps').get(b2bShopCloneController.get_final_customer_shops_Maps)
