...
const update_one_stream_two = async (req) => {
    ...
    let value = await Streamrequest.findByIdAndUpdate({ _id: req.query.id }, { sepTwo: "Completed", planId: req.body.plan_name,Duration:plan.Duration,endTime:datess.getTime() }, { new: true })
    return value;
};
